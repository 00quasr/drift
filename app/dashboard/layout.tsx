...
export default function DashboardLayout({
  ...
  // Check if user has permission to access dashboard - ADMIN ONLY
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/60 mb-6">Only administrators can access the dashboard.</p>
          <p className="text-white/40 text-sm mb-6">Use the role-specific options in your user menu instead.</p>
          <button
            onClick={() => router.push('/')}
